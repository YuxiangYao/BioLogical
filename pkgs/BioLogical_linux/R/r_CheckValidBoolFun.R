#' @title Boolean function checker
#' @description Check whether the input vector is a valid Boolean function
#' @param Bit_Vec A Boolean vector (or 0/1-valued IntegerVector) represents the 
