...
- Download the compressed files of the source code.
   ...
   `download.file("https://github.com/YuxiangYao/BioLogical/refs/heads/main/pkg_source/BioLogical_0.1.19_linux.tar.gz", "BioLogical_0.1.19.tar.gz")`
  
   `install.packages("/your/directory/to/file/BioLogical_0.1.19.tar.gz", repos=NULL)`

### Windows:
- `devtools::install_github("YuxiangYao/BioLogical/pkgs/BioLogical_win/")`
- Download the compressed files of the source code.

   `download.file("https://github.com/YuxiangYao/BioLogical/refs/heads/main/pkg_source/BioLogical_0.1.19_win.tar.gz", "BioLogical_0.1.19.tar.gz")`
...
- Download the compressed files of the source code.
   ...
   `download.file("https://github.com/YuxiangYao/BioLogical/refs/heads/main/pkg_source/BioLogical_0.1.19_mac.tar.gz", "BioLogical_0.1.19.tar.gz")`
